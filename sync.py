    ...
    def collect_training_data(self, days_back: int = 7) -> Dict:
        ...
        data = {
            "READ_THIS_FIRST": {
                ...
                "coaching_directives": "RÔLE : 
                Tu es mon coach sportif (course à pied).
                ...
                "display_formatting": "For durations and sleep, always display the '_formatted' fields (e.g., sleep_formatted, duration_formatted, total_training_formatted) instead of converting decimal '_hours' values. The formatted fields are pre-calculated from raw seconds and avoid rounding errors.",                "data_period": f"Last {days_back} days (including today)",
